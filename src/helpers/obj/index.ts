  ...
  page1: {
    arrProjects: [
      ...
      },
      {
        ...
        text: "Rgba Generator Desenvolvido com React JS, React Hooks, Css-Flexbox, Date-Fns",
        buttonText: "Vizualizar Projeto",
  ...
  page2: {
    arrProjects: [
      ...
      },
      {
        ...
        text: "User Registration Desenvolvido com React JS, React Hooks,",
        buttonText: "Vizualizar Projeto",
        link: "https://github.com/Gabriel200395/user-registration",
      },
      {
        titulo: "Github Profiles",
        text: "Github Profiles Desenvolvido com React JS, React Router, React Hooks, Css-Flexbox, Date-Fns,",
        buttonText: "Vizualizar Projeto",
